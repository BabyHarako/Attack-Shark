...
el('dpiMinusBtn').addEventListener('click', () => syncDpiDisplay(parseInt(el('dpiNumberBox').value) - 50));
el('dpiPlusBtn').addEventListener('click', () => syncDpiDisplay(parseInt(el('dpiNumberBox').value) + 50));
